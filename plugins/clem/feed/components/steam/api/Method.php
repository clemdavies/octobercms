...
use Clem\Feed\Components\Steam\Models\Settings;
...
class Method
{
    ...
    */
    public function __construct( $parameters ){
        ...
        $this->urlTemplate = Config::get('clem.feed.steam::api.urltemplates.'.Config::get('clem.feed.steam::api.methods.'.$this->name.'.urltemplate'));
    ...
    */
    ...
    private function initParameters(){
        $this->parameters = Config::get('clem.feed.steam::api.methods.'.$this->name.'.parameters');
    }
